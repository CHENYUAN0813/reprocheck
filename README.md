...
- Quick verification, CPU-limited Evaluation, confirmed configuration-driven CPU Training and the reviewed Iris Training case run only through the local Docker-backed server; unconfigured Training and automatic arbitrary-paper reproduction remain disabled
