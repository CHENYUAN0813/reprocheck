...
import capacityMatrix from "./spotify-cpu-matrix.json" with { type: "json" };
...
export const reviewedBenchmarks = [...bthowenBenchmarks.map(withBthowenRuntime), capacityBenchmark, capacityMatrix];
